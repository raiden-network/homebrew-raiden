class Raiden < Formula
  ...
  url "https://github.com/raiden-network/raiden/releases/download/v0.100.3-rc7/raiden-v0.100.3-rc7-macOS-x86_64.zip"
  version "v0.100.3-rc7"
  sha256 "90df67ab90d32b670dfda867fa3442b780b473e6f824859cd631f266758592ef"

  depends_on :macos => :el_capitan

  def install
    mv "raiden-v0.100.3-rc7-macOS-x86_64", "raiden"
    bin.install "raiden"
  end
